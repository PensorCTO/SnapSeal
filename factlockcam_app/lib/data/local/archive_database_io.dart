...
Future<void> _migrateLegacyArchiveDatabaseIfNeeded(String documentsPath) async {
...
class ArchiveDatabase {
  ...
  Future<Database> get _db async {
    ...
    _opening = opening;
    try {
      final db = await _openArchiveDatabase();
      _database = db;
      opening.complete(db);
      return db;
  ...
  Future<Database> _openArchiveDatabase() async {
    final documents = await getApplicationDocumentsDirectory();
    await _migrateLegacyArchiveDatabaseIfNeeded(documents.path);
