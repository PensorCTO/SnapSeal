...
| ENABLE_PROOF_LINKS | Compile-time dart-define; `AppConfig.enableProofLinks` gates Send Proof / `createCourierPackage`. Default **false** for App Store until `scripts/verify_web_archive_deploy.sh` passes. | [[App_Store_Hardening_2026-05]], [[Send_Proof_Courier_2026-05]] |
