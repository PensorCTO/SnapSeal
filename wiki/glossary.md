...
| Isolate lock coordinator | Sprint 4 `IsolateLockCoordinator` + `assetLockStateProvider`: mirrors in-flight vault writes to **SECURING FILE…** overlays; `FileLock.exclusive` on staging I/O in worker isolates. | [[Isolate_Lock_Coordinator]] |
