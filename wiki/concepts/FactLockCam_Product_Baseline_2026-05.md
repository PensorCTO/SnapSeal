...
- **Courier / Send Proof:** Certificate PDF + courier package + share sheet wired (`SendProof` notifier); **no in-app email**. Production **`WEB_ARCHIVE_BASE_URL`** in dart-defines — **Ngrok OK for TestFlight**; purchased domain required before App Store review ([[App_Store_Remediation_2026-05]], [[Send_Proof_Courier_2026-05]]).
