...
- [[SnapSeal_Master_Blueprint]] - Current-state application blueprint covering completed capabilities, four-panel vault UX, media-type-driven archive actions, unfinished work, and working use cases.
