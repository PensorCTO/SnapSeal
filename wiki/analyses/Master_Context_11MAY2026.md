...
- **Tests:** Widget coverage now exercises hub/archive actions, photo full-size action, forensic viewfinder widgets, retry behavior, and native channel shims; `flutter analyze` + `flutter test` are green (21 tests after the shutter-painter refresh).
