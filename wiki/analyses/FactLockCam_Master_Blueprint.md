...
* *Hub, archive, and local wallet behavior*: Derived from `snapseal_app/lib/ui/views/vault_home_view.dart`, `snapseal_app/lib/ui/views/archive_view.dart`, `snapseal_app/lib/ui/views/archive_item_actions.dart`, `snapseal_app/lib/core/archive/domain/models/media_action_type.dart`, `snapseal_app/lib/core/archive/domain/services/asset_action_registry.dart`, `snapseal_app/lib/core/archive/presentation/widgets/universal_asset_toolbar.dart`, `snapseal_app/lib/features/archive/presentation/providers/asset_action_provider.dart`, `snapseal_app/lib/ui/views/archive_photo_view.dart`, `snapseal_app/lib/ui/views/archive_video_view.dart`, `snapseal_app/lib/ui/controllers/dashboard_controller.dart`, and `snapseal_app/lib/data/models/archive_item.dart` (2026-04-30; re-verified 2026-05-10; four-panel UX + archive delete/full-size view/video thumbnails refreshed 2026-05-11; Domain Interaction Contract + cached photo-view extraction refreshed 2026-05-12)
...
* *Testing state*: Derived from `snapseal_app/test/widget_test.dart`, `snapseal_app/test/vault_service_retry_test.dart`, `snapseal_app/test/vault_dashboard_view_test.dart`, `snapseal_app/test/native_enclave_channel_test.dart`, `snapseal_app/test/archive_asset_actions_test.dart`, `snapseal_app/test/archive_photo_view_test.dart`, and `snapseal_app/test/vault_service_video_thumbnail_test.dart` (2026-05-11; expanded 2026-05-12)
